...
class App:
    ...
    def validar_item(self):
        """
        FUNÇÃO QUE RECEBE AS ENTRADAS DO USUÁRIO, FAZ A VALIDAÇAÕ DOS DADOS DO ITEM E O RETORNA.
        :return Objeto item to tipo 'Produto':
        """
    ...
    def adicionar_item(self, event=None):
        ...
        nome_itens_adicionados = [nome.nome for nome in self.itens]
    ...
    def criar_janela_itens(self):
        """
        FUNÇÃO QUE VERIFICA O STATUS (True ou False) DA JANELA 'VER ITENS' E A CRIA CASO JÁ NÃO TENHA SIDO ABERTA.
        """
        if self.status_janela_itens is False:
            ...
            if len(names) > 0:
                ...
                self.janela_itens.geometry("380x440+845+100")
    ...
    def fechar_janela_item(self):
        """
        FUNÇÃO FECHAR JANELA 'VER ITENS'.
        """
...
def fechar_programa():
    """
    FUNÇÃO FECHAR JANELA PRINCIPAL E JANELAS PARENTES. (Fecha todo o programa)
    """
